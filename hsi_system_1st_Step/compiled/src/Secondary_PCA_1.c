...
////////////////////////////////////////////////////////////////////////////////
// Input FIFOs
extern fifo_float_t *Secondary_PCA_1_PCA_Secondary_in;
extern fifo_i32_t *Secondary_PCA_1_Sche_Pointer;
...
#define tokens_PCA_Secondary_in Secondary_PCA_1_PCA_Secondary_in->contents

extern connection_t connection_Secondary_PCA_1_PCA_Secondary_in;
#define rate_PCA_Secondary_in connection_Secondary_PCA_1_PCA_Secondary_in.rate

static unsigned int index_Sche_Pointer;
static unsigned int numTokens_Sche_Pointer;
#define SIZE_Sche_Pointer SIZE
#define tokens_Sche_Pointer Secondary_PCA_1_Sche_Pointer->contents

extern connection_t connection_Secondary_PCA_1_Sche_Pointer;
#define rate_Sche_Pointer connection_Secondary_PCA_1_Sche_Pointer.rate
...
////////////////////////////////////////////////////////////////////////////////
// Output FIFOs
extern fifo_float_t *Secondary_PCA_1_PCA_Secondary_out;
extern fifo_i32_t *Secondary_PCA_1_Sec_Pointer;
...
#define tokens_PCA_Secondary_out Secondary_PCA_1_PCA_Secondary_out->contents
...
#define tokens_Sec_Pointer Secondary_PCA_1_Sec_Pointer->contents
...
#define Secondary_PCA_1_bands4core 55
#define Secondary_PCA_1_rc 10000
...
static void read_PCA_Secondary_in() {
	index_PCA_Secondary_in = Secondary_PCA_1_PCA_Secondary_in->read_inds[0];
	numTokens_PCA_Secondary_in = index_PCA_Secondary_in + fifo_float_get_num_tokens(Secondary_PCA_1_PCA_Secondary_in, 0);
}

static void read_end_PCA_Secondary_in() {
	Secondary_PCA_1_PCA_Secondary_in->read_inds[0] = index_PCA_Secondary_in;
}
static void read_Sche_Pointer() {
	index_Sche_Pointer = Secondary_PCA_1_Sche_Pointer->read_inds[0];
	numTokens_Sche_Pointer = index_Sche_Pointer + fifo_i32_get_num_tokens(Secondary_PCA_1_Sche_Pointer, 0);
}

static void read_end_Sche_Pointer() {
	Secondary_PCA_1_Sche_Pointer->read_inds[0] = index_Sche_Pointer;
}

static void write_PCA_Secondary_out() {
	index_PCA_Secondary_out = Secondary_PCA_1_PCA_Secondary_out->write_ind;
	numFree_PCA_Secondary_out = index_PCA_Secondary_out + fifo_float_get_room(Secondary_PCA_1_PCA_Secondary_out, NUM_READERS_PCA_Secondary_out, SIZE_PCA_Secondary_out);
}

static void write_end_PCA_Secondary_out() {
	Secondary_PCA_1_PCA_Secondary_out->write_ind = index_PCA_Secondary_out;
}
static void write_Sec_Pointer() {
	index_Sec_Pointer = Secondary_PCA_1_Sec_Pointer->write_ind;
	numFree_Sec_Pointer = index_Sec_Pointer + fifo_i32_get_room(Secondary_PCA_1_Sec_Pointer, NUM_READERS_Sec_Pointer, SIZE_Sec_Pointer);
}

static void write_end_Sec_Pointer() {
	Secondary_PCA_1_Sec_Pointer->write_ind = index_Sec_Pointer;
}
...
static i32 isSchedulable_receive_scheduler() {
	...
	local_bands4core = Secondary_PCA_1_bands4core;
...
void Secondary_PCA_1_initialize(schedinfo_t *si) {
	int i = 0;
...
////////////////////////////////////////////////////////////////////////////////
// Action scheduler
void Secondary_PCA_1_scheduler(schedinfo_t *si) {
	int i = 0;
	si->ports = 0;
	...
	while (1) {
		if (numTokens_PCA_Secondary_in - index_PCA_Secondary_in >= 10000 && numTokens_Sche_Pointer - index_Sche_Pointer >= 1 && isSchedulable_receive_scheduler()) {
			int stop = 0;
			if (10000 > SIZE_PCA_Secondary_out - index_PCA_Secondary_out + Secondary_PCA_1_PCA_Secondary_out->read_inds[0]) {
				stop = 1;
			}
			if (1 > SIZE_Sec_Pointer - index_Sec_Pointer + Secondary_PCA_1_Sec_Pointer->read_inds[0]) {
				stop = 1;
			}
			if (stop != 0) {
				si->num_firings = i;
